				...
				var calendar =  $('#calendar').fullCalendar({
					...
					events: [
                        <g:each in="${clinic_history_list}" var="cList">
    						{
	    						id: 999,
		    					title: "${cList.typeTreatment} ${cList.canines.nameCanine}",
			    				start: new Date(<g:formatDate format="yyyy" date="${cList.dateTreatment}"/>, <g:formatDate format="MM" date="${cList.dateTreatment}"/>-1, <g:formatDate format="dd" date="${cList.dateTreatment}"/>, 12, 0),
                                allDay: false,
					    		className: 'success'
    						},
                        </g:each>
				...
				<div class="row">
					<div class="col-sm-5 col-sm-offset-3">
						<div class="basic-login">
							<g:form controller = "K9Veterinarian" action="index">
								<div class="form-group">
                                    <p align="center"><button type="submit" class="btn-grey">Inicio</button></p>
