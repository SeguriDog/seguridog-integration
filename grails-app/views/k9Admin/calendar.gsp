				...
				var calendar =  $('#calendar').fullCalendar({
					...
					events: [
                        <g:each in="${activities_list}" var="aList">
    						{
	    						id: 999,
		    					title: "${aList.userOfService} ${aList.addressUbicationWorkArea} ${aList.handlers.fullName}",
                        ...
                        <g:each in="${exercise_ability_list}" var="eList">
    						{
	    						id: 999,
		    					title: "${eList.typeTraining} ${eList.canines.nameCanine} ${eList.instructors.fullName}",
			    				start: new Date(<g:formatDate format="yyyy" date="${eList.dateAbility}"/>, <g:formatDate format="MM" date="${eList.dateAbility}"/>-1, <g:formatDate format="dd" date="${eList.dateAbility}"/>, 14, 0),
                                allDay: false,
					    		className: 'chill'
    						},
                        </g:each>
                        <g:each in="${clinic_history_list}" var="cList">
    						{
	    						id: 999,
		    					title: "${cList.typeTreatment} ${cList.canines.nameCanine} ${cList.medics.fullName}",
			    				start: new Date(<g:formatDate format="yyyy" date="${cList.dateTreatment}"/>, <g:formatDate format="MM" date="${cList.dateTreatment}"/>-1, <g:formatDate format="dd" date="${cList.dateTreatment}"/>, 10, 0),
                                allDay: false,
					    		className: 'success'
    						},
                        </g:each>
				...
				<div class="row">
					<div class="col-sm-5 col-sm-offset-3">
						<div class="basic-login">
							<g:form controller = "K9Admin" action="index">
								<div class="form-group">
                                    <p align="center"><button type="submit" class="btn-green">Inicio</button></p>
