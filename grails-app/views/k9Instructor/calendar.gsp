				...
				var calendar =  $('#calendar').fullCalendar({
					...
					events: [
                        <g:each in="${exercise_ability_list}" var="eList">
    						{
	    						id: 999,
		    					title: "${eList.typeTraining} ${eList.canines.nameCanine}",
			    				start: new Date(<g:formatDate format="yyyy" date="${eList.dateAbility}"/>, <g:formatDate format="MM" date="${eList.dateAbility}"/>-1, <g:formatDate format="dd" date="${eList.dateAbility}"/>, 12, 0),
                                allDay: false,
					    		className: 'chill'
    						},
                        </g:each>
				...
				<div class="row">
					<div class="col-sm-5 col-sm-offset-3">
						<div class="basic-login">
							<g:form controller = "K9Instructor" action="index">
								<div class="form-group">
                                    <p align="center"><button type="submit" class="btn-red">Inicio</button></p>
