...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	<head>
        ...
        <style>
        			body{
        				background: #DFDFDF url("${request.contextPath}/purpose/img/page-background-gray.png") repeat top left;
        				font-family:Arial;
        			}
        			ul.sdt_menu{
                         margin: 0 auto;
        			...
        			<ul id="sdt_menu" class="sdt_menu">
        				...
        				<li>
        					<g:link controller="k9Veterinarian" action="register_clinic_history">
        						...
        						<span class="sdt_active"></span>
        						<span class="sdt_wrap">
        							<span class="sdt_link">Registrar H Clinica</span>
        							<span class="sdt_descr">SeguriDog</span>
        						</span>
        					</g:link>
        				</li>
        				<li>
        					...
        					<div class="sdt_box">
                                 <g:link controller="k9Veterinarian" action="search_user">Usuarios del Sistema</g:link>
