...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	<head>
        ...
        <style>
        			body{
        				background: #DFDFDF url("${request.contextPath}/purpose/img/page-background-green.png") repeat top left;
        				font-family:Arial;
        			}
        			ul.sdt_menu{
                         margin: 0 auto;
        		...
        		<div class="content">
        			<ul id="sdt_menu" class="sdt_menu">
        				...
        				<li>
        					...
        					<div class="sdt_box">
                                <g:link controller="k9Admin" action="register_user">Nuevo Usuario</g:link>
                                <g:link controller="k9Admin" action="register_dog">Nuevo Canino</g:link>
                                <g:link controller="k9Admin" action="register_service">Nuevo Servicio</g:link>
                            </div>
        				</li>
        				<li>
        					<g:link controller="k9Admin" action="index">
